...
Requests sent using the raw audio file will have reduced latencies. JSON input can only be sent via Python, as there are specific data processing requirements.
